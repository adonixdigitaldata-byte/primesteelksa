        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col space-y-4">
            <Link href="/" className="flex items-center gap-2 group w-max">
              <div className="w-10 h-10 bg-gradient-to-tr from-brand-primary to-brand-primary-light rounded-lg flex items-center justify-center font-bold text-brand-dark text-xl shadow-glow">
                P
              </div>
